            ...
            document.querySelectorAll(f).forEach((t) => {
              ...
              if (n) n.parentElement.remove();
                ...
                chrome.storage.local.get(n, (o) => {
                  ...
                  r &&
                    r[e] &&
                    t.querySelector(".popcorn-source").append(d(e, r[e]));
                });
              }
            });
          })(t);
...
async function a(t, n = "netflix", o) {
  if (t.id) {
    const e = await ((a = t.id),
    new Promise((e, t) => {
      chrome.storage.local.get(a, (n) => {
        Object.keys(n).length ? e("object" == typeof a ? n : n[a]) : e(),
...
function i(e) {
  const t =
    e.hasAttribute("id") && e.className.includes("jawBoneContainer")
      ? e
      : e.querySelector("div.jawBoneContainer[id]");
  if (t) return t.id;
  const n = e.querySelector(".ptrack-content");
  if (n) {
    const e = n
      .getAttribute("data-ui-tracking-context")
      .match(/%22video_id%22:(\d+)/);
...
function d(e, t, n = !1) {
  ...
  "imdb" === e
    ...
    ? ((r = "Tomatometer"),
      ...
      t.rating >= 75
        ? (o += "certified")
        : (o += t.rating >= 65 || null === t.rating ? "fresh" : "rotten"))
  ...
  const a = l("div", {
      ...
      attrs: {
        title: r,
        "aria-label": r,
        style: `background-image:url(${chrome.runtime.getURL(
          `images/${o || e}.png`
        )})`,
      },
    }),
    i = t.rating
      ? ""
      : "Not enough votes or our data is outdated. Click to check in the source page.",
    s = l("div", {
      className: c + "rating",
      text: t.rating || "-",
      attrs: {
...
function l(e = "div", { className: t, attrs: n = {}, text: o } = {}, r) {
...
function u(e, t, r) {
  const a = (function (e = "bigrow", t = {}, n = !1) {
    ...
    const a = s.reduce(
        (e, r) => (o[r] && t[r] && e.push(d(r, t[r], n)), e),
        []
      ),
      i = l(
        "div",
  ...
  if (((n = new Date()), "billboard" === e || "jawbone" === e)) {
    const e =
      r.querySelector(".info-wrapper-fade") || r.querySelector(".info-wrapper");
    if (e) return void e.prepend(a);
    i = r.querySelector(".meta") || r.querySelector(".video-title");
  }
  if (
    ("bigrow" === e && (i = r.querySelector(".billboard-title")), "modal" !== e)
  )
    if (
      ("mini" === e && (i = r.querySelector(".buttonControls--container")),
      "titlecard" !== e)
    )
      i && i.after(a);
    else {
        ...
        m.forEach((e) => {
          !(function (e, t) {
            ...
            n.setAttribute("data-id", e.id),
              (n.textContent = e.title || e.content);
            const o = document.createElement("span");
            if (
              ((o.textContent = "popcorn: "),
              (o.className = "popcorn-prefix"),
              n.prepend(o),
              e.link)
            ) {
...
const w = {
  ...
  b = new MutationObserver((e, t) => {
    ...
    document.querySelector(".mainView") &&
      (t.disconnect(), g.observe(n, w), M(n), C(n));
  }),
  ...
  y = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        "overview" === e.target.getAttribute("data-popcorn") &&
        !e.target.querySelector(f) &&
        e.addedNodes.length &&
        !e.addedNodes[0].classList.contains("js-transition-node") &&
        e.target.querySelector(
          '.jawBonePane[id*="overview" i]:not(.js-transition-node)'
        )
    );
    t &&
      ((t =
        t.target.closest(".jawBoneContent") ||
        t.target.closest(".jawBoneContainer[id]")),
      B("jawbone", t));
  }),
  v = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        e.addedNodes.length &&
        /mainView|genre|is-fullbleed/.test(e.target.className)
    );
    if (t) {
      t = t.target;
  ...
  h = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        "jawbone" === e.target.getAttribute("data-popcorn") &&
        e.addedNodes.length
    );
    if (t) {
      (t = t.target.closest(".jawBoneContent") || t.target),
        x(t.querySelector(".jawBoneOpenContainer"), "jawbone");
  ...
  S = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        e.target.classList.contains("title") && e.target.querySelector("img")
    );
    if (t) {
      t = t.target;
      const e =
        t.closest(".jawBoneContent") || t.closest(".jawBoneContainer[id]");
      if (e) {
  ...
  q = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        e.addedNodes.length &&
        /section-container/.test(e.addedNodes[0].className)
    );
    if (t) {
      t = t.addedNodes[0];
  ...
  N = new MutationObserver((e) => {
    let t = e.find(
      (e) =>
        e.addedNodes.length &&
        e.addedNodes[0].classList.contains("previewModal--wrapper")
    );
    if (t)
      if (((t = t.addedNodes[0]), /mini-modal/.test(t.className))) {
        !(function (e) {
          if (
            e.querySelector(".duration") ||
            e.querySelector(".previewModal-progress") ||
            e.querySelector(".previewModal-episodeDetails")
          )
            B("mini", e);
          else {
            new MutationObserver((t, n) => {
              t.find(
                (e) =>
                  e.addedNodes.length &&
                  /duration|progress|episodeDetail/.test(
                    e.addedNodes[0].className
                  )
              ) && (B("mini", e), n.disconnect());
            }).observe(e, w);
          }
        })(t);
  ...
  e.querySelectorAll(".jawBoneContent").forEach((e) => {
    x(e, "jawbone"),
      ...
      e.classList.contains("open") &&
        !e.querySelector(f) &&
        (x(e.querySelector(".jawBoneOpenContainer"), "jawbone"),
        B("jawbone", e));
  });
...
function C(e) {
  const t =
    e.querySelector(".jawBoneContainer[id]") ||
    e.querySelector(".billboard-row");
...
function B(e, n) {
  a(
    (function (e) {
      let n, o;
      const r =
        e.querySelector(".jawBone > h3 .title") ||
        e.querySelector(".jawBone > h1") ||
        e.querySelector(".billboard-title") ||
        e.querySelector(".previewModal--player_container") ||
        e.querySelector(".titleCard-imageWrapper");
      if (r) {
        const e = r.querySelector('img:not([alt=""])');
        (n = e ? e.alt : null),
          (n = r.querySelector('img:not([alt=""])')
            ? r.querySelector('img:not([alt=""])').alt
            : null);
      } else n = null;
      const a =
        e.querySelector(".meta .year") ||
        e.querySelector(".videoMetadata--container .year");
      o = a ? a.textContent : null;
      const c = i(e),
        s = (function (e) {
          if (e.querySelector(".previewModal-episodeDetails")) return "tv";
          const t =
            e.querySelector(".info-wrapper") ||
            e.querySelector(".duration") ||
            e.querySelector(".previewModal-progress");
          return t
            ? /(^S\d+)|[sS]eason|[pP]art/.test(t.textContent)
              ? "tv"
              : "movie"
            : null;
        })(e);
...
function E(e) {
  const t = e.classList.contains("lolomoBigRow")
    ? e
    : e.querySelector(".lolomoBigRow");
...
function A() {
  ...
  if (
    ...
    t && k(t),
      document.querySelector('style[data-name="popcorn"]') ||
        (function () {
          const e =
            document.querySelector(".jawBoneContainer") ||
            document.querySelector(".billboard-pane");
...
window.addEventListener("popstate", () => {
  /browse|title|search/.test(window.location.href) &&
    (N.disconnect(), g.disconnect(), v.disconnect(), A());
}),
  A();
